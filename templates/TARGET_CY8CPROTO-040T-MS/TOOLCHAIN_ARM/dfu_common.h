...
#define CY_BOOT_METADATA_ADDR       0x0000FE00
...
#define CY_APP0_RAM_LENGTH          0x00001C00

#define CY_APP1_RAM_ADDR            (CY_APP_RAM_COMMON_ADDR + CY_APP_RAM_COMMON_LENGTH)
#define CY_APP1_RAM_LENGTH          0x00001C00

/* Memory region ranges per applications */

#define CY_APP0_FLASH_ADDR          0X00000000
#define CY_APP0_FLASH_LENGTH        0x00003500

#define CY_APP1_FLASH_ADDR          0x00003500
#define CY_APP1_FLASH_LENGTH        0x0000C900

/* DFU SDK metadata address range in flash */
#define CY_BOOT_META_FLASH_ADDR     0x0000FE00
