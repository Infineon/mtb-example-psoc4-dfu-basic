...
#define CY_BOOT_METADATA_ADDR       0x00007E00
...
#define CY_APP0_RAM_LENGTH          0x00000B00

#define CY_APP1_RAM_ADDR            (CY_APP_RAM_COMMON_ADDR + CY_APP_RAM_COMMON_LENGTH)
#define CY_APP1_RAM_LENGTH          0x00000B00

/* Memory region ranges per applications */

#define CY_APP0_FLASH_ADDR          0X00000000
#define CY_APP0_FLASH_LENGTH        0x00004000

#define CY_APP1_FLASH_ADDR          0x00004000
#define CY_APP1_FLASH_LENGTH        0x00003000

/* DFU SDK metadata address range in flash */
#define CY_BOOT_META_FLASH_ADDR     0x00007E00
